    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Cập nhật thông tin chuyên khoa khám bệnh</p>
            </div>
                ...
                <div class="p-8">
                    <form method="POST" action="{{ route('specialties.update', $specialty) }}" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" id="name" name="name" value="{{ $specialty->name }}"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="number" id="fee" name="fee" value="{{ $specialty->fee }}"
                ...
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-800">
                        ...
                        <ul class="list-disc list-inside space-y-1 text-blue-700">
                            <li>Tên chuyên khoa phải được điền đầy đủ và chính xác</li>
                            <li>Phí khám sẽ được hiển thị cho bệnh nhân khi đăng ký</li>
                            <li>Tạm ngưng chuyên khoa sẽ không cho phép bệnh nhân mới đăng ký</li>
                        </ul>
                    </div>
                </div>
            </div>
